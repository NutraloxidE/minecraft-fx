...
set "SERVER_PASSWORD=your-password"
set "TARGET_DIR=/path/to/minecraft/plugins"

:: SSH ログインに必要です。必要なら書き換えてください。
set "SERVER_USER=root"
set "SERVER_HOSTKEY=ssh-ed25519 255 SHA256:replace-with-your-host-key"
...
set "GRADLE=C:\path\to\gradle.bat"
set "PROJECT_DIR=%~dp0"
